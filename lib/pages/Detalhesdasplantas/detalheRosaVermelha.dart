...
class detalheRosavermelha extends StatelessWidget {
  const detalheRosavermelha({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Center(
            child: const Image(
              image: AssetImage("assets/RosaVermelha.png"),
            ),
          ),
          SizedBox(height: 10),
          Expanded(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 12),
                          Text(
                            "Informação extra: 4 horas de sol",
                            style: TextStyle(
                              fontFamily: 'Montserrat Alternates',
                              fontSize: 37,
