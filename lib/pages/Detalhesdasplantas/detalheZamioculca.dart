...
class DetalheZamioculca extends StatelessWidget {
  const DetalheZamioculca({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Center(
            child: const Image(
              image: AssetImage("assets/zamioculca.png"),
              width: 400,
              height: 200,
            ),
          ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 12),
                          Text(
                            "Informação extra:4h de sol direto por dia.",
                            style: TextStyle(
                              fontFamily: 'Montserrat Alternates',
                              fontSize: 37,
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 12),
                          Text(
                            "Luminosidade: Sombra (luz indireta).",
                            style: TextStyle(
                              fontFamily: 'Montserrat Alternates',
                              fontSize: 37,
                              fontWeight: FontWeight.w400,
