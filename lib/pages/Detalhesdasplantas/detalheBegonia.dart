...
class DetalheBegonia extends StatelessWidget {
  const DetalheBegonia({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Center(
            child: const Image(
              image: AssetImage("assets/Planta Begonia-Rex.png"),
            ),
          ),
          SizedBox(height: 10),
          Expanded(
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 12),
                          Text(
                            "Informação extra: 2 horas de sol por dia.",
                            style: TextStyle(
                              fontFamily: 'Montserrat Alternates',
                              fontSize: 37,
