...
class DetalhePeperomia extends StatelessWidget {
  const DetalhePeperomia({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Center(
            child: const Image(
              image: AssetImage("assets/Peperomia.png"),
              width: 400,
              height: 200,
            ),
          ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 12),
                          Text(
                            "Informação extra:4h de luz indireta por dia.",
                            style: TextStyle(
                              fontFamily: 'Montserrat Alternates',
                              fontSize: 37,
